...
define('TXT_WPSC_LANGUAGE', '????');
define('TXT_WPSC_ACCEPTED_PAYMENT', '?????? ??????');
define('TXT_WPSC_JOB_DISPATCHED', '?????? ???????????');
...
define('TXT_WPSC_OLDER_ORDERS', '?????? ??????');
define('TXT_WPSC_ORDER', '?????');
define('TXT_WPSC_TOTAL_THIS_MONTH', '????? ????? ??????? ? ???? ??????');
define('TXT_WPSC_MONTHLY_REPORT', '????? ????? ???????');
define('TXT_WPSC_TOTAL_INCOME', '????? ?????');
define('TXT_WPSC_ACCEPTED_PAYMENTS', '(???????? ??????)'); //texr has changed slightly
...
define('TXT_WPSC_PAYPALBUSINESS', 'paypal ??????');
...
define('TXT_WPSC_TAXALREADYINCLUDED', 'Tax is already included (tax is set in shop config)'); // this text has changed and needs updating
...
define('TXT_WPSC_PLEASEENTERAVALIDEMAILADDRESS', '????????? ??????? ????????? E-MAIL');
