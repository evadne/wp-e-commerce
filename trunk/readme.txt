=== WP e-Commerce ===
Contributors: Dan Milward, Thomas Howard, Chris Beavan
...
= I'm Having "presentation" problems - what do I do?=

Check out the shop options page in the WP e-commerce panel. 

Advanced users can edit the CSS (and do just about anything). Not so advanced users can contact Instinct and purchase profession support - either that or use our forums.

= Where do I find DropShop and Grid View? =

From the BlogShop: www.instinct.co.nz/blogshop


== Screenshots ==

1. We're taking this one step further. 

Check out our flickr guides:
