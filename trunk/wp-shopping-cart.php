...
function nzshpcrt_submit_ajax()
  ...
  if(($_POST['ajax'] == "true") && ($_POST['remove_variation_value'] == "true") && is_numeric($_POST['variation_value_id']))
   ...
   if(($_POST['ajax'] == "true") && ($_POST['get_updated_price'] == "true") && is_numeric($_POST['product_id']))
    ...
    echo "price=\"\$".calculate_product_price($_POST['product_id'], $variations)."\";\n";
    exit();
    }
  ...
  if(($_GET['rss'] == "true") && ($_GET['action'] == "product_list"))
   ...
   // Undo these changes after they have been placed in amdefromnewzealand
...
//   $output .= TXT_WPSC_LIMITED_STOCK.": ";
  ...
  if(function_exists("getimagesize"))
    ...
    if($product['image'] != '')
      ...
      $output .= "            <td>\n\r";
// pe.{
    // Currently not implemented thumbnail DB field
  ...
  $output .= "<br /><span style=\"font-size: 7pt;\">" . TXT_WPSC_PRODUCT_IMAGE_PREVIEW . "</span><br /><br />";
    ...
    if(($product['thumbnail_image'] != null))
      ...
      $output .= "<a id='preview_link' href='".$thumbnail_location . "' rel='lightbox' class='lightbox_links'><img id='previewimage' src='" . $thumbnail_location . "' alt='".TXT_WPSC_PREVIEW."' title='".TXT_WPSC_PREVIEW."' />"."</a>";
...
function nzshpcrt_shopping_basket_internals($cart,$quantity_limit = false, $title='')
  ...
  switch(get_option('cart_location'))
    {
    case 1:
    $output .= "<h2>".TXT_WPSC_SHOPPINGCART."</h2>";
    ...
    case 3:
    $output .= "<strong>".TXT_WPSC_SHOPPINGCART."</strong>";
    $spacing = "<br/><br />";
    break;
