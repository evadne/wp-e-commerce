...
define('TXT_WPSC_PLUGIN_NEWS', utf8_encode('<a href="http://www.instinct.co.nz/wp-campaign-monitor/100" target="_blank">WP Monitor de campaña</a> es un email de promociones para los usuarios de WP. 
 
La última versión integra el boletín de noticias, con el que usted será capaz de enviar a los compradores los boletines de noticias a su email y mucho más.'));
