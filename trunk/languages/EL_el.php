...
define('TXT_WPSC_IMAGESIZEINFO', 'Σημείωση: Αν αυτό είναι κενό, η φωτογραφία δεν θα αλλάξει μέγεθος.');
define('TXT_WPSC_RECEIVED', 'Νέα παραγγελία');
define('TXT_WPSC_ORDER_STATUS', 'Κατάσταση παραγγελίας');
define('TXT_WPSC_ORDER_SUMMARY', 'Σύνοψη παραγγελιών');
define('TXT_WPSC_LANGUAGE', 'Γλώσσα');
define('TXT_WPSC_ACCEPTED_PAYMENT', 'Επιβεβαίωση πληρωμής');
define('TXT_WPSC_JOB_DISPATCHED', 'Αποστολή παραγγελίας');
define('TXT_WPSC_PROCESSED', 'Ολοκληρωμένη παραγγελία');
define('TXT_WPSC_ECOMMERCE', 'e-Εμπόριο');
define('TXT_WPSC_OPTIONS', 'Επιλογές καταστήματος');
define('TXT_WPSC_ADDPRODUCTS', 'Νέα προϊόντα');
define('TXT_WPSC_SENDSMS', 'Αποστολή SMS');
define('TXT_WPSC_PRODUCTS', 'Προϊόντα');
define('TXT_WPSC_ADDCATEGORY', 'Νέα κατηγορία');
define('TXT_WPSC_CATEGORIES', 'Κατηγορίες');
define('TXT_WPSC_BRANDS', 'Μάρκες');
define('TXT_WPSC_VARIATIONS', 'Παραλλαγές');
define('TXT_WPSC_PURCHASELOG', 'Καταστατικό παραγγελιών');
define('TXT_WPSC_ORDER_LOG', 'Παραγγελίες');
define('TXT_WPSC_OLDER_ORDERS', 'Παλαιότερες παραγγελίες');
define('TXT_WPSC_ORDER', 'Παραγγελία');
define('TXT_WPSC_TOTAL_THIS_MONTH', 'Μηνιαία απόδοση');
define('TXT_WPSC_MONTHLY_REPORT', 'Εξάμηνη αναφορά');
define('TXT_WPSC_TOTAL_INCOME', 'Συνολική απόδοση');
define('TXT_WPSC_ACCEPTED_PAYMENTS', '(Επιβεβαιωμένες πληρωμές)');
define('TXT_WPSC_PAYMENTGATEWAYOPTIONS', 'Επιλογές πύλης');
define('TXT_WPSC_HELPINSTALLATION', 'Βοήθεια/Αναβάθμιση');
define('TXT_WPSC_EXAMPLECATEGORY', 'Παράδειγμα κατηγορίας');
define('TXT_WPSC_EXAMPLEDETAILS', 'Παράδειγμα στοιχείων');
define('TXT_WPSC_EXAMPLEBRAND', 'Παράδειγμα μάρκας');
define('TXT_WPSC_PRODUCTIMAGEWIDTH', 'Πλάτος φωτογραφίας προϊόντος');
define('TXT_WPSC_PRODUCTIMAGEHEIGHT', 'Ύψος φωτογραφίας προϊόντος');
define('TXT_WPSC_CATEGORYIMAGEWIDTH', 'Πλάτος φωτογραφίας κατηγορίας');
define('TXT_WPSC_CATEGORYIMAGEHEIGHT', 'Ύψος φωτογραφίας κατηγορίας');
define('TXT_WPSC_PRODUCTLISTURL', 'Η τοποθεσία του καταλόγου προϊόντων');
define('TXT_WPSC_SHOPPINGCARTURL', 'Η τοποθεσία του καλαθιού αγορών');
define('TXT_WPSC_CHECKOUTURL', 'Η τοποθεσία της σελίδας του ταμείου');
define('TXT_WPSC_TRANSACTURL', 'Η τοποθεσία της σελίδας συναλλαγής στοιχείων');
define('TXT_WPSC_PAYMENTGATEWAY', 'Πύλη πληρωμών');
define('TXT_WPSC_CARTLOCATION', 'Τοποθεσία καλαθιού');
define('TXT_WPSC_SHOWCATEGORYBRANDS', 'Εμφάνιση κατηγορίας ή μάρκας ή και των δύο');
define('TXT_WPSC_CURRENCYTYPE', 'Νόμισμα');
define('TXT_WPSC_CURRENCYSIGNLOCATION', 'Τοποθεσία συμβόλου');
define('TXT_WPSC_GSTRATE', 'επιτόκιο GST');
define('TXT_WPSC_MAXDOWNLOADS', 'Το download όριο');
define('TXT_WPSC_DISPLAYPNP', 'Εμφάνιση ή απόκρυψη του τρόπου πακεταρίσματος και αποστολής');
define('TXT_WPSC_DISPLAYSPECIALS', 'Εμφάνιση ή απόκρυψη των προσφορών στην παράπλευρη μπάρα');
define('TXT_WPSC_POSTAGEAND_PACKAGING', 'Προεπιλογή τρόπου πακεταρίσματος και αποστολής');
define('TXT_WPSC_PURCHLOGEMAIL', 'Email διεύθυνση αποστολής καταστατικού παραγγελιών');
define('TXT_WPSC_RETURNEMAIL', 'Email διεύθυνση αποστολέα αναφορών παραγγελιών');
define('TXT_WPSC_TERMSANDCONDITIONS', 'Όροι χρήσης και πληρωμής');
define('TXT_WPSC_DEFAULTBRAND', 'Προεπιλεγμένη μάρκα');
define('TXT_WPSC_DEFAULTCATEGORY', 'Προεπιλεγμένη κατηγορία');
define('TXT_WPSC_PAYPALBUSINESS', 'paypal business');
define('TXT_WPSC_PAYPALURL', 'paypal url');
define('TXT_WPSC_SHOWPRODUCTRATINGS', 'Εμφάνιση βαθμολόγησης προϊόντων');
define('TXT_WPSC_PRODUCTSPAGE', 'Σελίδα προϊόντων');
define('TXT_WPSC_CHECKOUT', 'Ταμείο');
define('TXT_WPSC_ENTERDETAILS', 'Εισαγωγή στοιχείων');
define('TXT_WPSC_TRANSACTIONRESULTS', 'Αποτελέσματα συναλλαγής');
define('TXT_WPSC_SELECTACATEGORY', 'Επιλογή κατηγορίας');
define('TXT_WPSC_SELECTABRAND', 'Επιλογή μάρκας');
define('TXT_WPSC_PRODUCTNAME', 'Όνομα προϊόντος');
define('TXT_WPSC_PRODUCTDESCRIPTION', 'Περιγραφή προϊόντος');
define('TXT_WPSC_ADDITIONALDESCRIPTION', 'Επιπρόσθετη περιγραφή');
define('TXT_WPSC_PRICE', 'Τιμή');
define('TXT_WPSC_TAXALREADYINCLUDED', 'Χωρίς ΦΠΑ (Το ΦΠΑ ορίζετε στις επιλογές καταστήματος)');
define('TXT_WPSC_SPECIAL', 'Τιμή προσφοράς/έκπτωσης');
define('TXT_WPSC_PRODUCT_DISPLAY', 'Εμφάνιση προϊόντων');

define('TXT_WPSC_PRODUCTSTOCK', 'Απόθεμα προϊόντος');

define('TXT_WPSC_UNTICKBOX', 'Υπάρχει περιορισμένος αριθμός αποθεμάτων αυτού του προϊόντος. Αν εξαντληθεί το απόθεμα, αυτό το προϊόν δεν θα είναι διαθέσιμο εκτός και αν δεν είναι επιλεγμένη αυτή η επιλογή ή προστεθεί περισσότερο απόθεμα.');
define('TXT_WPSC_LIMITED_STOCK', 'Περιορισμένο απόθεμα');

define('TXT_WPSC_CATEGORY', 'Κατηγορία');
define('TXT_WPSC_BRAND', 'Μάρκα');
define('TXT_WPSC_PRODUCT_VARS', 'Παραλλαγές προϊόντος');
define('TXT_WPSC_ADD_VAR', 'Νέο σύνολο παραλλαγής');
define('TXT_WPSC_EDIT_VAR', 'Επεξεργασία συνόλου παραλλαγής');
define('TXT_WPSC_SELECTAVARIATION', 'Επιλογή παραλλαγής');
define('TXT_WPSC_NEW_VARIATION', 'Δημιουργία νέας παραλλαγής');

define('TXT_WPSC_PRODUCTATT', 'Επισυνάψεις');
define('TXT_WPSC_DOWNLOADABLEPRODUCT', 'Προϊόν για download');
define('TXT_WPSC_FILETOBEPRODUCT', 'Σημείωση: Αν αυτό συμπληρωθεί, το καταχωρημένο αρχείο θα είναι το προϊόν προς πώληση.');
define('TXT_WPSC_RESIZEIMAGE', 'Αλλαγή μεγέθους μικρογραφίας');
define('TXT_WPSC_DONOTRESIZEIMAGE', 'Αμετάβλητο μέγεθος μικρογραφίας');
//define('TXT_WPSC_USEDEFAULTHEIGHTANDWIDTH', 'Χρήση προεπιλεγμένου ύψους και πλάτους');
//define('TXT_WPSC_USE', 'χρήση');
//define('TXT_WPSC_PXHEIGHTBY', 'px ύψος επί');
//define('TXT_WPSC_PXWIDTH', 'px πλάτος.');

// pe.{
//define('TXT_WPSC_USEDEFAULTHEIGHTANDWIDTH', 'Χρήση προεπιλεγμένου ύψους και πλάτους');
// }.pe
define('TXT_WPSC_SEPARATETHUMBNAIL', 'Χρήση ξεχωριστής μικρογραφίας');
define('TXT_WPSC_USE', 'χρήση');
// pe.{
define('TXT_WPSC_USEDEFAULTSIZE', 'Χρήση προεπιλεγμένου μεγέθους');
define('TXT_WPSC_USESPECIFICSIZE', 'Χρήση συγκεκριμένου μεγέθους');
define('TXT_WPSC_PXHEIGHT', 'px ύψος');
define('TXT_WPSC_PXWIDTH', 'px πλάτος');
// }.pe

define('TXT_WPSC_PREVIEW', 'Προεπισκόπηση');
define('TXT_WPSC_UPLOADNEWIMAGE', 'Αντικατάσταση φωτογραφίας');
define('TXT_WPSC_DELETEIMAGE', 'Διαγραφή φωτογραφίας');
define('TXT_WPSC_EDIT', 'Επεξεργασία');
define('TXT_WPSC_DELETE', 'Διαγραφή');
define('TXT_WPSC_REMOVE', 'Αφαίρεση');
define('TXT_WPSC_NAME', 'Όνομα');
define('TXT_WPSC_TYPE', 'Τύπος');
define('TXT_WPSC_MANDATORY', 'Υποχρεωτικό');
define('TXT_WPSC_DISPLAY_IN_LOG', 'Εμφάνιση<br /> στο καταστατικό');
define('TXT_WPSC_DESCRIPTION', 'Περιγραφή');
define('TXT_WPSC_CATEGORY_PARENT', 'Γονική κατηγορία');
define('TXT_WPSC_IMAGE', 'Φωτογραφία');
define('TXT_WPSC_HEIGHT', 'Ύψος');
define('TXT_WPSC_WIDTH', 'Πλάτος');
define('TXT_WPSC_PLEASEENTERAVALID', 'Παρακαλώ συμπληρώστε');
define('TXT_WPSC_PLEASEENTERAVALIDNAME', 'Παρακαλώ συμπληρώστε το όνομα σας');
define('TXT_WPSC_PLEASEENTERAVALIDSURNAME', 'Παρακαλώ συμπληρώστε το επώνυμο σας');
define('TXT_WPSC_PLEASEENTERAVALIDEMAILADDRESS', 'Παρακαλώ συμπληρώστε την email διεύθυνση σας');
define('TXT_WPSC_PLEASEENTERAVALIDADDRESS', 'Παρακαλώ συμπληρώστε την ταχυδρομική διεύθυνση σας');
define('TXT_WPSC_PLEASEENTERAVALIDPHONENUMBER', 'Παρακαλώ συμπληρώστε το τηλέφωνο σας');
define('TXT_WPSC_TERMSANDCONDITIONS', 'Δεν έχετε αποδεχτεί τους όρους χρήσης και πληρωμής');
define('TXT_WPSC_NOTHINGINYOURSHOPPINGCART', 'Το καλάθι αγορών σας είναι άδειο');
define('TXT_WPSC_SPECIALS', 'Προσφορές');
define('TXT_WPSC_BUY', 'Αγορά');
define('TXT_WPSC_SHOPPINGCART', 'Καλάθι αγορών');
define('TXT_WPSC_NUMBEROFITEMS', 'Αντικείμενα');
define('TXT_WPSC_NOMOREAVAILABLE', 'Αυτό το προϊόν έχει εξαντληθεί');
define('TXT_WPSC_EMPTYYOURCART', 'Άδειασμα του καλαθιού');
define('TXT_WPSC_GOTOCHECKOUT', 'Πληρωμή');
define('TXT_WPSC_CONTINUESHOPPING', 'Επιστροφή στα προϊόντα');
define('TXT_WPSC_YOURSHOPPINGCARTISEMPTY', 'Άδειο καλάθι αγορών');
define('TXT_WPSC_VISITTHESHOP', 'Επίσκεψη στο κατάστημα');
define('TXT_WPSC_PAGES', 'Σελίδες');
define('TXT_WPSC_OUTOF', 'από');
define('TXT_WPSC_VOTES', 'ψήφους.');
define('TXT_WPSC_CLICKSTARSTORATE', 'Επιλέξτε αστέρι για να ψηφίσετε');
define('TXT_WPSC_AVERAGERATINGOF', 'Μέσος όρος από');
define('TXT_WPSC_YOURVOTE', 'Η ψήφος σας');
define('TXT_WPSC_AVERAGEVOTE', 'Μέση ψήφος');
define('TXT_WPSC_YOUHAVEVOTED', 'Έχετε ψηφίσει');
define('TXT_WPSC_NOVOTES', 'Χωρίς ψήφους');
define('TXT_WPSC_1VOTE', '1 ψήφος');
define('TXT_WPSC_VOTES2', 'Ψήφους');
define('TXT_WPSC_PERSONGIVEN', 'άτομο έχει βαθμολογήσει αυτή τη φωτογραφία');
define('TXT_WPSC_PERSONGIVEN2', 'αστέρια.');
define('TXT_WPSC_PEOPLEGIVEN', 'άτομα έχουν βαθμολογήσει αυτή τη φωτογραφία');
define('TXT_WPSC_PEOPLEGIVEN2', 'αστέρια.');
define('TXT_WPSC_ITEMHASBEENADDED', 'Το προϊόν προστέθηκε στο καλάθι');
define('TXT_WPSC_ITEMHASNOTBEENADDED', 'Το προϊόν δεν προστέθηκε στο καλάθι');
define('TXT_WPSC_ADDNEWCATEGORY', 'Νέα κατηγορία');
define('TXT_WPSC_SUBMIT', 'Αποστολή');
define('TXT_WPSC_SELECTAVALIDCATEGORY', 'Παρακαλώ διαλέξτε μια έγκυρη κατηγορία');
define('TXT_WPSC_PRODUCTNAME', 'Όνομα προϊόντος');
define('TXT_WPSC_PRODUCTDESCRIPTION', 'Περιγραφή προϊόντος');
define('TXT_WPSC_ADDNEWPRODUCT', 'Νέο προϊόν');
define('TXT_WPSC_PRODUCTQUANTITY', 'Productquantity');
define('TXT_WPSC_PRODUCTIMAGE', 'Φωτογραφία προϊόντος');
define('TXT_WPSC_PRODUCTPRICE', 'Τιμή προϊόντος');
define('TXT_WPSC_NOTAX', 'Αφορολόγητο');
define('TXT_WPSC_ABOUT', 'Περί');
...
define('TXT_WPSC_CONTACTDETAILS', 'Παρακαλώ συμπληρώστε τα στοιχεία σας:');
...
define('TXT_WPSC_FIRSTNAME', 'Όνομα');
define('TXT_WPSC_LASTNAME', 'Eπώνυμο');
define('TXT_WPSC_EMAIL', 'Email');
define('TXT_WPSC_ADDRESS', 'Διεύθυνση');
define('TXT_WPSC_ADDRESS1', 'Διεύθυνση 1');
define('TXT_WPSC_ADDRESS2', 'Διεύθυνση 2');
define('TXT_WPSC_CITY', 'Πόλη');
define('TXT_WPSC_COUNTRY', 'Χώρα');
define('TXT_WPSC_PHONE', 'Τηλέφωνο');
define('TXT_WPSC_TERMS1', 'Αποδέχομαι τους ');
define('TXT_WPSC_TERMS2', 'όρους χρήσης και πληρωμής');


define('TXT_WPSC_TEXT', 'Κείμενο');
define('TXT_WPSC_TEXTAREA', 'Textarea');
define('TXT_WPSC_HEADING', 'Heading');

define('TXT_WPSC_MAKEPURCHASE', 'Αγορά');
...
define('TXT_WPSC_ADDBRAND', 'Νέα μάρκα');
define('TXT_WPSC_DISPLAYBRANDS', 'Μάρκες');
define('TXT_WPSC_EDITBRAND', 'Επεξεργασία μάρκας');
define('TXT_WPSC_ADD', 'Πρόσθεση');
define('TXT_WPSC_ADD_NEW_FORM', 'Νέο πεδίο φόρμας');
define('TXT_WPSC_SAVE_CHANGES', 'Καταχώριση αλλαγών');

define('TXT_WPSC_CATEGORYHASBEENEDITED', 'The category has been edited.');
define('TXT_WPSC_DISPLAYCATEGORIES', 'Κατηγορίες');
define('TXT_WPSC_ADDCATEGORY', 'Νέα κατηγορία');
define('TXT_WPSC_EDITCATEGORY', 'Επεξεργασία κατηγορίας');
define('TXT_WPSC_ALLCATEGORIES', 'Όλες τις κατηγορίες');

define('TXT_WPSC_DISPLAYVARIATIONS', 'Παραλλαγές');
...
define('TXT_WPSC_ADDPRODUCT', 'Νέο προϊόν');
define('TXT_WPSC_DISPLAYPRODUCTS', 'Προϊόντα');
define('TXT_WPSC_PLEASESELECTACATEGORY', 'Παρακαλώ διαλέξτε μία κατηγορία');
define('TXT_WPSC_STOCK', 'Απόθεμα');
...
define('TXT_WPSC_CHOOSEACATEGORY', 'Επιλογή κατηγορίας');
define('TXT_WPSC_CHOOSEABRAND', 'Επιλογή μάρκας');
define('TXT_WPSC_USETHEACTUALIMAGE', 'χρήση αρχικής φωτογραφίας, χωρίς αλλαγή μεγέθους.');
define('TXT_WPSC_DISPLAYPURCHASES', 'Καταστατικό παραγγελιών');
define('TXT_WPSC_ID', 'ID');
define('TXT_WPSC_TRANSACTIONSTATUS', 'Κατάσταση συναλλαγής');
define('TXT_WPSC_DATE', 'Ημερομηνία');
define('TXT_WPSC_VIEWDETAILS', 'Λεπτομέρειες');
define('TXT_WPSC_STATUS', 'Κατάσταση');
define('TXT_WPSC_SUCCESSFUL', 'Επιτυχία');
define('TXT_WPSC_FAILED', 'Αποτυχία');
define('TXT_WPSC_GST', 'GST');
define('TXT_WPSC_PP', 'P&amp;P');
define('TXT_WPSC_TOTAL', 'Σύνολο');
define('TXT_WPSC_FINALTOTAL', 'Τελικό σύνολο');
define('TXT_WPSC_CUSTOMERDETAILS', 'Λεπτομέρειες πελάτη');
define('TXT_WPSC_USERSCARTWASEMPTY', 'This users cart was empty');
define('TXT_WPSC_GOBACK', 'Επιστροφή');
define('TXT_WPSC_THANKSAPPLIED', 'Thanks, your changes have been applied.');
define('TXT_WPSC_FORM_FIELDS', 'Επιλογές ταμείου');
...
define('TXT_WPSC_BOTH', 'και τα δύο');
...
define('TXT_WPSC_YES', 'Ναι');
define('TXT_WPSC_NO', 'Όχι');
define('TXT_WPSC_SHOWSPECIALS', 'Εμφάνιση προσφορών');
define('TXT_WPSC_SHOWPRODUCTRATINGS', 'Εμφάνιση ψήφων προϊόντων');
define('TXT_WPSC_CURRENCYSETTINGS', 'Επιλογές νομίσματος');
...
define('TXT_WPSC_BRANDNOCAP', 'μάρκα');
define('TXT_WPSC_CATEGORYNOCAP', 'κατηγορία');
define('TXT_WPSC_UDPATING', 'Updating');
define('TXT_WPSC_MOREDETAILS', 'Περισσότερες πληροφορίες');
define('TXT_WPSC_ADDTOCART', 'Πρόσθεση στο καλάθι');
...
define('TXT_WPSC_PLEASECHOOSEA', 'Επιλέξτε');
define('TXT_WPSC_PRODUCT', 'Προϊόν');
define('TXT_WPSC_QUANTITY', 'Ποσότητα');
define('TXT_WPSC_QUANTITY_SHORT', 'Ποσότ'); //translation needed
define('TXT_WPSC_APPLY', 'Εφαρμογή');
define('TXT_WPSC_MAKEPAYMENT', 'Πληρωμή');
define('TXT_WPSC_EMPTYSHOPPINGCART', 'Άδειασμα του καλαθιού αγορών');
...
define('TXT_WPSC_GOLD_OPTIONS', 'Επιλογές Gold Cart');
...
define('TXT_WPSC_PLEASEENTERAVALIDEMAILADDRESS', 'Παρακαλώ συμπληρώστε την email διεύθυνση σας.');
define('TXT_WPSC_PLEASEENTERAVALIDADDRESS', 'Παρακαλώ συμπληρώστε την ταχυδρομική διεύθυνση σας.');
define('TXT_WPSC_PLEASEENTERAVALIDCITY', 'Παρακαλώ συμπληρώστε την πόλη σας.');
define('TXT_WPSC_PLEASEENTERAVALIDPHONENUMBER', 'Παρακαλώ συμπληρώστε το τηλέφωνο σας.');
define('TXT_WPSC_PLEASESELECTCOUNTRY', 'Παρακαλώ διαλέξτε την χώρα σας από την λίστα.');
...
define('TXT_WPSC_POSITION', 'Θέση');

define('TXT_WPSC_DELIVERY_REGION', 'Delivery Region');


define('TXT_WPSC_GENERAL_SETTINGS', 'Γενικές επιλογές');
define('TXT_WPSC_TAX_SETTINGS', 'Επιλογές φόρου προστιθέμενης αξίας');
define('TXT_WPSC_POSTAGE_AND_TAX', 'Postage &amp; Tax ');
define('TXT_WPSC_GRID', 'Πλέγμα');
...
define('TXT_WPSC_VARIATION', 'Παραλλαγή');
