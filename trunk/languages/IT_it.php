...
define('TXT_WPSC_CHECKOUTURL', 'La posizione della pagina di checkout');
...
define('TXT_WPSC_GOTOCHECKOUT', 'Procedi al Checkout');
...
define('TXT_WPSC_GOBACKTOCHECKOUT', 'Torna al checkout');
...
define('TXT_WPSC_PLUGIN_NEWS', '<a href="http://www.instinct.co.nz/wp-campaign-monitor/100" target="_blank">WP Campaign Monitor</a> e\' un tool che permette di inviare newsletter
da parte di utenti WP per news su campagne, seguirne i 
risultati e gestire le sottoscrizioni. 
 
L\'ultima versione e\' integrata con e-commerce lite quindi
anche voi site in grado di inviare newsletters ai vostri
clienti e motlo di piu\'.');
