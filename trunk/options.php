...
/*<tr>
      <td>
      <?php echo TXT_WPSC_GOOGLESTORELOCATOR;?>:
      </td>
      <td>
      <?php
$googleStoreLocator = get_option('googleStoreLocator');
$googleStoreLocator1 = "";
$googleStoreLocator2 = "";
switch($googleStoreLocator)
  {
  case 0:
  $googleStoreLocator2 = "checked ='true'";
  break;
  
  case 1:
  $googleStoreLocator1 = "checked ='true'";
  break;
  }
      ?>
      <input type='radio' value='1' name='googleStoreLocator' id='googleStoreLocator1' <?php echo $googleStoreLocator1; ?> /> <label for='googleStoreLocator1'><?php echo TXT_WPSC_YES;?></label> &nbsp;
      <input type='radio' value='0' name='googleStoreLocator' id='googleStoreLocator2' <?php echo $googleStoreLocator2; ?> /> <label for='googleStoreLocator2'><?php echo TXT_WPSC_NO;?></label>
      </td>
    </tr>  
*/ ?>
      ...
      <tr>
        <td colspan='2'><br />
        <strong class="form_group"><?php echo TXT_WPSC_PAGESETTINGS;?>:</strong>
        </td>
      </tr>
  ...
  switch($do_not_use_shipping)
    ...
    break;
        ...
        <input type='radio' value='1' name='do_not_use_shipping' id='do_not_use_shipping1' <?php echo $do_not_use_shipping1; ?> /> <label for='do_not_use_shipping1'><?php echo TXT_WPSC_NO;?></label><br />
         <?php echo TXT_WPSC_USE_SHIPPING_DESCRIPTION;?><br /><br />
        </td>
      </tr>
      <tr>
        <td>
  ...
  <tr>
		<td>
			<?php echo TXT_WPSC_SHIPWIRESETTINGS;?> :
		</td>
		<td>
			<input type='radio' onclick='jQuery("#wpsc_shipwire_setting").show()' value='1' name='shipwire' id='shipwire1' <?php echo $show_search1; ?> /> <label for='show_search1'><?php echo TXT_WPSC_YES;?></label> &nbsp;
			<input type='radio' onclick='jQuery("#wpsc_shipwire_setting").hide()' value='0' name='shipwire' id='shipwire2' <?php echo $show_search2; ?> /> <label for='show_search2'><?php echo TXT_WPSC_NO;?></label>
		</td>
	</tr>
		<?php
