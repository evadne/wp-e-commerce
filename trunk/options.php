...
//   
    ...
    if(is_numeric($_POST['wpsc_page_number_position']))
      {
      update_option('wpsc_page_number_position', $_POST['wpsc_page_number_position']);
      }
      else
        {
  ...
  switch($cart_location)
    ...
    break;
        ...
        if(function_exists('register_sidebar_widget'))
          {
        ?>
        <input type='radio' value='1' disabled='true'  name='cart_location' id='cart1' <?php echo $cart1; ?> /> <label style='color: #666666;' for='cart1'><?php echo TXT_WPSC_SIDEBAR;?></label> &nbsp;
        <?php
          }
          else
          {
      ...
      $show_images_only_value = '';
        ...
        ?>
          ...
          <div id='grid_view_options' <?php echo $list_view_quantity_style;?> <?php if(is_null($product_view3)) { echo "style='display:none;'";} ?>>
            ...
            <label for='show_images_only'><?php echo TXT_SHOW_IMAGES_ONLY;?></label>
          </div>
        </td>
      </tr>
      <?php
...
if(function_exists('gold_shpcrt_search_form'))
  ...
  switch($display_pnp)
    ...
    break;
        ...
        ?>
        <input type='radio' value='1' name='show_search' id='show_search1' <?php echo $show_search1; ?> /> <label for='show_search1'><?php echo TXT_WPSC_YES;?></label> &nbsp;
        <input type='radio' value='0' name='show_search' id='show_search2' <?php echo $show_search2; ?> /> <label for='show_search2'><?php echo TXT_WPSC_NO;?></label>
        </td>
      </tr>
  <?php
  }
