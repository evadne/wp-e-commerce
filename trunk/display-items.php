...
<div id='additem'>
  ...
  if(function_exists("getimagesize") && is_numeric(get_option('product_image_height')) && is_numeric(get_option('product_image_width')))
    ...
    ?>
      <tr>
        <td>
      <input type='radio' checked='true' name='image_resize' value='0' id='image_resize0' class='image_resize' onclick='hideOptionElement(null, "image_resize0");' /> <label for='image_resize0'><?php echo TXT_WPSC_DONOTRESIZEIMAGE; ?></label>
        </td>
      </tr>
      <tr>
        <td>
          <input type='radio' name='image_resize' value='1' id='image_resize1' class='image_resize' onclick='hideOptionElement(null, "image_resize1");' /> <label for='image_resize1'><?php echo TXT_WPSC_USEDEFAULTSIZE;?> (<?php echo get_option('product_image_height') ."x".get_option('product_image_width'); ?>)</label>
        </td>
      </tr>
    <?php  
  ...
  if(function_exists("getimagesize"))
    ...
    ?>
      <tr>
        <td>
          <input type='radio' name='image_resize' value='2' id='image_resize2' class='image_resize'  onclick='hideOptionElement("heightWidth", "image_resize2");' />
      <label for='image_resize2'><?php echo TXT_WPSC_USESPECIFICSIZE; ?> </label>        
          <div id='heightWidth' style='display: none;'>
        <input type='text' size='4' name='width' value='' /><label for='image_resize2'><?php echo TXT_WPSC_PXWIDTH;?></label>
        <input type='text' size='4' name='height' value='' /><label for='image_resize2'><?php echo TXT_WPSC_PXHEIGHT; ?> </label>
      </div>
        </td>
      </tr>
      <tr>
      <td>
        <input type='radio' name='image_resize' value='3' id='image_resize3' class='image_resize' onclick='hideOptionElement("browseThumb", "image_resize3");' />
        <label for='image_resize3'><?php echo TXT_WPSC_SEPARATETHUMBNAIL; ?></label><br />
