...
*/
define('TXT_WPSC_SHOW_BREADCRUMBS', 'Показывать крошки');
define('TXT_WPSC_PURCHASE_UNAVAILABLE', 'Купить недостающие опции');
define('TXT_WPSC_WE_RECOMMEND', 'Мы рекомендуем');
define('TXT_WPSC_CONFIGURE_PAYMENT_GATEWAY', ' Выберите способ оплаты ниже, чтобы настроить его.');
define('TXT_WPSC_CHOOSE_PAYMENT_GATEWAYS', 'Выберите способы платежей, которые будут доступны вашим посетителям.');
define('TXT_WPSC_PAYMENT_GATEWAYS', 'Платежные шлюзы');
...
define('TXT_WPSC_ADDING_TO_GROUP', 'Вы добавляете новый пункт к [categorisation] группе');
define('TXT_WPSC_SELECT_PRODUCT_GROUP', 'Выберите группу');
define('TXT_WPSC_SKU', 'SKU');
define('TXT_WPSC_NO_SHORTCODE', 'Этот товар все еще ждет добавления в ваш каталог. Нет доступных сокращений или тэгов в данный момент.');
define('TXT_WPSC_ABOUT_THIS_PAGE', 'Об этой странице');
define('TXT_WPSC_YOUAREUSING', 'Вы используете :theme: стиль. Это WP e-Commerce :versionnumber:.');
define('TXT_WPSC_PRODUCTCOUNT_SINGULAR','продукт');
define('TXT_WPSC_PRODUCTCOUNT_PLURAL','продукты');
define('TXT_WPSC_GROUPCOUNT_SINGULAR','группа');
define('TXT_WPSC_GROUPCOUNT_PLURAL','групп');
define('TXT_WPSC_SALECOUNT_SINGULAR','продажа');
define('TXT_WPSC_SALECOUNT_PLURAL','продаж');
define('TXT_WPSC_PENDINGCOUNT_SINGULAR','транзакция');
define('TXT_WPSC_PENDINGCOUNT_PLURAL','транзакций');
define('TXT_WPSC_SALES_DASHBOARD', 'У вас <a href=\'admin.php?page=wp-shopping-cart/display-items.php\'>:productcount:</a>, содержащихся в <a href=\'admin.php?page=wp-shopping-cart/display-category.php\'>:groupcount:</a>. В этом месяце вы сделали :salecount: и собрали :monthtotal: . Всего продаж  на сумму :overaltotal:. У вас :pendingcount: ожидающих подтверждения.');
define('TXT_WPSC_NO_DEFAULT_PRODUCTS', 'Ваша страница "products page" все еще не настроена чтобы отображать какие-либо продукты. Вам необходимо выбрать группу продуктов для отображения по умолчанию. <br /> Это можно сделать на странице настройки магазина.');
define('TXT_WPSC_VARIATION_LIST', 'Выбрать представление');
define('TXT_WPSC_WRONG_FILE_PERMS', 'Следующие каталоги не имеют рпава на запись: :directory: У вас нет возмоджности закачивать какие-либо изображения или файлы. Вам необходимо установить права на запись для вышеперечисленных каталогов.');
define('TXT_WPSC_CATEGORISATIONHASBEENADDED', 'Группа была добавлена.');
define('TXT_WPSC_ADMINMENU', 'Меню администрирования');
define('TXT_WPSC_PRICE_RANGE', 'Интервал цен');
define('TXT_WPSC_LATEST_PRODUCTS', 'Новые продукты');
define('TXT_WPSC_PRODUCT_SPECIALS', 'Спецпредложения');
define('TXT_WPSC_DONATIONS', 'Пожертвования');
define('TXT_WPSC_USING_EXAMPLE_CATEGORY', 'Вы используете тестовую группу продуктов по умолчанию и в ней нет ни одного продукта. Вам необходимо установить каку-то другую группу, как группу по умолчанию. Вы можете это сделать на странице настроек магазина.');
define('TXT_WPSC_UDPATING', 'Обновление');
define('TXT_WPSC_SELECTGATEWAY', 'Выбрать способ оплаты');
define('TXT_WPSC_YOU_JUST_ADDED', 'Вы только что добавили "[product_name]" в корзину.');
define('TXT_WPSC_CONTINUE_SHOPPING', 'Продолжить выбор товаров');
...
define('TXT_WPSC_CATEGORISATION', 'Категории');
define('TXT_WPSC_ADD_CATEGORISATION', 'Добавить новую группу');
define('TXT_WPSC_CHECKOUT', 'Обзор корзины');
define('TXT_WPSC_TRANSACTIONRESULTS', 'Результаты транзакций');
define('TXT_WPSC_YOUR_ACCOUNT', 'Ваш аккаунт');

define('TXT_WPSC_CATEGORISATION_GROUPS_DESCR', 'Категории помогают вашим посетителям искать товар. Если вы продаете шляпы, футболки и трусы, то вы можете добавить категорию одежда и добавить все эти товары туда. Теперь вы можете сортировать продукты по категориям, к которым они относятся.');
define('TXT_WPSC_MANAGE_CATEGORISATION', 'Управлять [categorisation]'); 
define('TXT_WPSC_ADDDETAILS', 'Добавить описание');
define('TXT_WPSC_ECOM_NEWS', 'Новости e-Commerce');
define('TXT_WPSC_MENU', 'e-Commerce Меню администрирования');
define('TXT_WPSC_LOG_TRANSACTIONACCEPTEDLOGS', 'Отображать только ппринятые заказы');
define('TXT_WPSC_SEARCHEMAIL', 'Искать по e-mail адресу');
define('TXT_WPSC_OPTIONS_GENERAL_TAB', 'Главная');
define('TXT_WPSC_OPTIONS_PRESENTATION_TAB', 'Представление');
...
define('TXT_WPSC_OPTIONS_GENERAL_HEADER', 'Основные установки');
define('TXT_WPSC_OPTIONS_PRESENTATION_HEADER', 'Установки представления');
define('TXT_WPSC_OPTIONS_SHIPPING_HEADER', 'Настройки доставки');
define('TXT_WPSC_OPTIONS_PAYMENT_HEADER', 'Настройки оплаты');
define('TXT_WPSC_OPTIONS_ADMIN_HEADER', 'Настройки администрирования');
define('TXT_WPSC_OPTIONS_MARKETING_HEADER', 'Настройки маркетинга');
define('TXT_WPSC_LOCK_DOWNLOADS_TO_IP', 'Привязать скачивание к IP адресу');
