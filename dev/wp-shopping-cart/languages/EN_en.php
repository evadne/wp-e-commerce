...
define('TXT_WPSC_CHOOSE_DOWNLOADABLE_VARIATIONS', 'Choose a downloadable file for this variation');
define('TXT_WPSC_FLASH_UPLOADER', 'You are using the Flash uploader.  Problems?  Try the [link]Browser uploader</a> instead.');
define('TXT_WPSC_BROWSER_UPLOADER', 'You are using the Browser uploader.  Problems?  Try the [link]Flash uploader</a> instead.');
